if exists('s:loaded_yamlator') || &cp
  finish
endif
let s:loaded_yamlator = 1

" Chunk copied from
" https://github.com/lmeijvogel/vim-yaml-helper/blob/master/plugin/vim-yaml-helper.vim
" Was not working right for some reason when loaded separately.
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" Published methods
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
function! YamlatorGetPath(...)
    if &filetype != "yaml"
        return ""
    endif
    return s:GetFullPath().g:airline_symbols.space.g:airline_right_alt_sep.g:airline_symbols.space
endfunction


call airline#parts#define_function('yamlpath', 'YamlatorGetPath')
call airline#parts#define_condition('yamlpath', '&filetype == "yaml"')
